...
# Output
<img width="1365" height="728" alt="image" src="https://github.com/user-attachments/assets/d8ebe3c6-25ae-4bfd-9e46-b253ce769809" />
...
2. **Run the app** (dependencies auto-install on first launch):
   ```bash
   python virtual_drum.py
   ```
3. Point the webcam toward your hands. Tap downward over each virtual pad to trigger sounds.
